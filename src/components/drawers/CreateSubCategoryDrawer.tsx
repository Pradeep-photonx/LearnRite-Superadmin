...
import { getCategoryList, createSubCategory, type Category, type CreateSubCategoryPayload } from "../../api/category";
...
const CreateSubCategoryDrawer: React.FC<CreateSubCategoryDrawerProps> = ({
    ...
    const handleSubmit = async () => {
        // Basic validation
        if (!formData.name || !formData.parentCategoryId || !formData.status) {
