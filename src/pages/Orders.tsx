...
import type { Order } from "../utilities/ordersData";
...
const Orders: React.FC = () => {
  ...
  const filteredOrders = ordersData.filter((order) => {
    ...
    return (
      ...
      order.customerType.toLowerCase().includes(query) ||
    ...
    <Box>
      ...
      >
        <Stack spacing={3} sx={{ marginBottom: "20px" }}>
          <Typography variant="sb20">Order Management</Typography>
          ...
          >
            ...
            >
              ...
              <InputBase
                placeholder="Search by order ID, customer name, or type"
                value={searchQuery}
            ...
            >
              <MenuItem onClick={handleFilterClose}>
                <Typography variant="r14">All Orders</Typography>
              </MenuItem>
              <MenuItem onClick={handleFilterClose}>
                <Typography variant="r14">Shipped</Typography>
              </MenuItem>
              <MenuItem onClick={handleFilterClose}>
                <Typography variant="r14">Not Shipped</Typography>
              </MenuItem>
              <MenuItem onClick={handleFilterClose}>
          ...
          <TableBody>
            {filteredOrders.map((order: Order) => (
              <TableRow key={order.id}>
                ...
                <TableCell>
                  <Typography>{order.customerType}</Typography>
                </TableCell>
                <TableCell>
                ...
                <TableCell>
                  <Chip
                    ...
                    sx={{
                      backgroundColor:
                        order.paymentStatus === "Active" ? "#D5F8E7" : "#F3F4F6",
                      color: order.paymentStatus === "Active" ? "#17B168" : "#6B7280",
                      fontWeight: 500,
                      fontSize: "14px",
                      borderRadius: "12px",
                      "& .MuiChip-label": {
